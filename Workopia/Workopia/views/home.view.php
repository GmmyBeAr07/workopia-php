      ...
      <div class="container mx-auto text-center z-10">
        ...
        <form class="mb-4 block mx-5 md:mx-auto">
          ...
          <input
            ...
            class="w-full md:w-auto mb-2 px-4 py-2 focus:outline-none"/>
          <button
            class="w-full md:w-auto bg-green-500 hover:bg-green-600 text-white px-4 py-2 focus:outline-none">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div class="rounded-lg shadow-md bg-white">
            <div class="p-4">
              ...
              <a href="details.html"
                class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium text-black-700 bg-green-100 hover:bg-green-200">
                Details
              </a>
            </div>
          </div>
